...
export default function App() {
  ...
  return (
    <>
      <a
        className="absolute top-0 right-0 p-4 mr-4 mt-4"
        href="http://github.com/StevenTete"
        target="_blank"
      ...
      <div className="container mx-auto px-4 md:py-8 py-4 max-w-2xl flex flex-col justify-center h-screen appears">
        <h1 className="md:text-3xl text-xl font-bold text-center mb-6 text-white flex items-center justify-center">
          <svg
            className="md:h-12 h-8  fill-white mr-3"
            role="img"
            viewBox="0 0 24 24"
            xmlns="http://www.w3.org/2000/svg"
          >
